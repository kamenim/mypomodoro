...
public class AboutPanel extends JDialog {
	...
	private void addAbout() {
		...
		checkButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				BareBonesBrowserLaunch
						.openURL("https://code.google.com/p/mypomodoro/downloads/list");
			}
		});
		...
		gbcpanel.fill = GridBagConstraints.BOTH;
		String about = Labels
				.getString("AboutPanel.myPomodoro is a time management tool");
	...
	private void addLicence() {
		...
		gbc.gridwidth = 2;
		gbc.fill = GridBagConstraints.BOTH;
		String license = Labels
				.getString("AboutPanel.myPomodoro is open-source software");
		license += "<br>"

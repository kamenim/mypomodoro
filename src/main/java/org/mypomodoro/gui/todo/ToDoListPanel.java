...
public class ToDoListPanel extends JPanel {
		...
		if (!pomodoro.inPomodoro()
			...
			if (selectedToDo != null) {
				...
				if (selectedToDo.getActualPoms() <= 0) {
					String title = Labels
							.getString("ToDoListPanel.Complete ToDo");
					String message = Labels
							.getString("ToDoListPanel.This ToDo has no finished pomodoro (real). Complete anyway?");
					...
					if (reply == JOptionPane.YES_OPTION) {
						...
						message = Labels
								.getString("ToDoListPanel.ToDo moved to Report List");
					...
					String title = Labels
							.getString("ToDoListPanel.Complete ToDo");
					String message = Labels
							.getString("ToDoListPanel.Are you sure to complete this ToDo?");
					int reply = JOptionPane.showConfirmDialog(window, message,
							title, JOptionPane.YES_NO_OPTION);
					if (reply == JOptionPane.YES_OPTION) {
						completeTask(selectedToDo);
			...
			String message = Labels
					.getString("ToDoListPanel.Please either stop or finish the current pomodoro (recommended)");
			JOptionPane.showConfirmDialog(window, message, title,
					JOptionPane.DEFAULT_OPTION);
		}
	}
	...
	public void completeAllTasksWithWarning() {
		if (!pomodoro.inPomodoro()) {
			...
			String message = Labels
					.getString("ToDoListPanel.Are you sure to complete ALL ToDo?");

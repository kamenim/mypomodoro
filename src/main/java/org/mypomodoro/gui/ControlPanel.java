...
public class ControlPanel extends JPanel {
	...
	public ControlPanel() {
		...
		Locale locale = new Locale(preferences.getLocale().getLanguage(),
				preferences.getLocale().getCountry(), preferences.getLocale()
						.getVariant());
		...
		saveButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent event) {
				setValidation(Labels
						.getString("PreferencesPanel.Preferences saved.") + " ");
				updatePreferences();
				disableSaveButton();
			}
		});
	...
	protected void addResetButton() { // values recommended by the Pomodoro
		...
		resetButton.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent event) {
				preferencesInputFormPanel.pomodoroSlider
						.setSliderValue(Preferences.PLENGTH);
				preferencesInputFormPanel.shortBreakSlider
						.setSliderValue(Preferences.SBLENGTH);
				preferencesInputFormPanel.longBreakSlider
						.setSliderValue(Preferences.LBLENGTH);
				preferencesInputFormPanel.maxNbPomPerActivitySlider
						.setSliderValue(Preferences.MNPPACTIVITY);
				preferencesInputFormPanel.maxNbPomPerDaySlider
						.setSliderValue(Preferences.MNPPDAY);
				preferencesInputFormPanel.nbPomPerSetSlider
						.setSliderValue(Preferences.NPPSet);
	...
	private void updatePreferences() {
		preferences.setPomodoroLength(preferencesInputFormPanel.pomodoroSlider
				.getSliderValue());
		preferences
				.setShortBreakLength(preferencesInputFormPanel.shortBreakSlider
						.getSliderValue());
		preferences
				.setLongBreakLength(preferencesInputFormPanel.longBreakSlider
						.getSliderValue());
		preferences
				.setMaxNbPomPerActivity(preferencesInputFormPanel.maxNbPomPerActivitySlider
						.getSliderValue());
		preferences
				.setMaxNbPomPerDay(preferencesInputFormPanel.maxNbPomPerDaySlider
						.getSliderValue());
		preferences.setNbPomPerSet(preferencesInputFormPanel.nbPomPerSetSlider
				.getSliderValue());
		preferences.setTicking(preferencesInputFormPanel.tickingBox
				.isSelected());
		preferences.setRinging(preferencesInputFormPanel.ringingBox
				.isSelected());
		preferences
				.setLocale(((ItemLocale) preferencesInputFormPanel.localesComboBox

...
public class ActivityInputForm extends JPanel {
	...
	public ActivityInputForm(int gridy) {
		...
		String items[] = new String[ControlPanel.preferences
	...
	public void setEstimatedPomodoros(int value) {
		value = value > ControlPanel.preferences.getMaxNbPomPerActivity() ? ControlPanel.preferences
				.getMaxNbPomPerActivity() : value;
	...
	public boolean isDateToday() {
		String datePickerFormat = DateUtil
				.getFormatedDate(datePicker.getDate());

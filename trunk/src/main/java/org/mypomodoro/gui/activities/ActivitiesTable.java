...
public class ActivitiesTable extends AbstractActivitiesTable {
    ...
    public ActivitiesTable(ActivitiesTableModel model, final ActivitiesPanel activitiesPanel) {
        super(model);
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (getSelectedRowCount() > 0) {
                    if (!e.getValueIsAdjusting()) { // ignoring the deselection event                                
                        ...
                        if (getSelectedRowCount() > 1) { // multiple selection
                        ...
                        activitiesPanel.setPanelBorder();
                    }
                } else {
                    activitiesPanel.setPanelBorder();
                }
        ...
        String[] cloneColumnNames = model.getColumnNames().clone();
        //String[] cloneColumnNames = model.getColumnNames();
        cloneColumnNames[model.getColumnCount() - 1 - 7] = Labels.getString("Common.Unplanned");
        cloneColumnNames[model.getColumnCount() - 1 - 6] = Labels.getString("Common.Date scheduled");
        cloneColumnNames[model.getColumnCount() - 1 - 3] = Labels.getString("Common.Estimated") + " (+ " + Labels.getString("Common.Overestimated") + ")";
        ...
        getColumnModel().getColumn(model.getColumnCount() - 1 - 7).setCellRenderer(new UnplannedRenderer()); // unplanned (custom renderer)
        getColumnModel().getColumn(model.getColumnCount() - 1 - 6).setCellRenderer(new DateRenderer()); // date (custom renderer)
        getColumnModel().getColumn(model.getColumnCount() - 1 - 5).setCellRenderer(new TitleRenderer()); // title
        // type combo box
        String[] types = (String[]) TypeList.getTypes().toArray(new String[0]);
        getColumnModel().getColumn(model.getColumnCount() - 1 - 4).setCellRenderer(new ActivitiesComboBoxCellRenderer(types, true));
        getColumnModel().getColumn(model.getColumnCount() - 1 - 4).setCellEditor(new ActivitiesComboBoxCellEditor(types, true));
        // Estimated combo box
        // The values of the combo depends on the activity : see EstimatedComboBoxCellRenderer and EstimatedComboBoxCellEditor
        getColumnModel().getColumn(model.getColumnCount() - 1 - 3).setCellRenderer(new ActivitiesEstimatedComboBoxCellRenderer(new Integer[0], false));
        getColumnModel().getColumn(model.getColumnCount() - 1 - 3).setCellEditor(new ActivitiesEstimatedComboBoxCellEditor(new Integer[0], false));
        // Story Point combo box
        Float[] points = new Float[]{0f, 0.5f, 1f, 2f, 3f, 5f, 8f, 13f, 20f, 40f, 100f};
        getColumnModel().getColumn(model.getColumnCount() - 1 - 2).setCellRenderer(new StoryPointsComboBoxCellRenderer(points, false));
        getColumnModel().getColumn(model.getColumnCount() - 1 - 2).setCellEditor(new StoryPointsComboBoxCellEditor(points, false));
        // Iteration combo box
        Integer[] iterations = new Integer[102];
        for (int i = 0; i <= 101; i++) {
            iterations[i] = i - 1;
        }
        getColumnModel().getColumn(model.getColumnCount() - 1 - 1).setCellRenderer(new IterationComboBoxCellRenderer(iterations, false));
        getColumnModel().getColumn(model.getColumnCount() - 1 - 1).setCellEditor(new IterationComboBoxCellEditor(iterations, false));
        // hide story points and iteration in 'classic' mode
        if (!Main.preferences.getAgileMode()) {
            getColumnModel().getColumn(model.getColumnCount() - 1 - 2).setMaxWidth(0);
            getColumnModel().getColumn(model.getColumnCount() - 1 - 2).setMinWidth(0);
            getColumnModel().getColumn(model.getColumnCount() - 1 - 2).setPreferredWidth(0);
            getColumnModel().getColumn(model.getColumnCount() - 1 - 1).setMaxWidth(0);
            getColumnModel().getColumn(model.getColumnCount() - 1 - 1).setMinWidth(0);
            getColumnModel().getColumn(model.getColumnCount() - 1 - 1).setPreferredWidth(0);
        } else {
            // Set width of columns story points, iteration
            getColumnModel().getColumn(model.getColumnCount() - 1 - 2).setMaxWidth(80);
            getColumnModel().getColumn(model.getColumnCount() - 1 - 2).setMinWidth(80);
            getColumnModel().getColumn(model.getColumnCount() - 1 - 2).setPreferredWidth(80);
            getColumnModel().getColumn(model.getColumnCount() - 1 - 1).setMaxWidth(80);
            getColumnModel().getColumn(model.getColumnCount() - 1 - 1).setMinWidth(80);
            getColumnModel().getColumn(model.getColumnCount() - 1 - 1).setPreferredWidth(80);
        }
        ...
        if (Main.preferences.getAgileMode()) {
            ...
            getColumnModel().getColumn(model.getColumnCount() - 1 - 6).setMaxWidth(0);
            getColumnModel().getColumn(model.getColumnCount() - 1 - 6).setMinWidth(0);
            getColumnModel().getColumn(model.getColumnCount() - 1 - 6).setPreferredWidth(0);
        } else {
            // Set width of columns Unplanned and date
            getColumnModel().getColumn(0).setMaxWidth(30);
            getColumnModel().getColumn(0).setMinWidth(30);
            getColumnModel().getColumn(0).setPreferredWidth(30);
            getColumnModel().getColumn(model.getColumnCount() - 1 - 6).setMaxWidth(90);
            getColumnModel().getColumn(model.getColumnCount() - 1 - 6).setMinWidth(90);
            getColumnModel().getColumn(model.getColumnCount() - 1 - 6).setPreferredWidth(90);
        }
        // Set width of column estimated
        getColumnModel().getColumn(model.getColumnCount() - 1 - 3).setMaxWidth(80);
        getColumnModel().getColumn(model.getColumnCount() - 1 - 3).setMinWidth(80);
        getColumnModel().getColumn(model.getColumnCount() - 1 - 3).setPreferredWidth(80);
        // Set width of column type
        getColumnModel().getColumn(model.getColumnCount() - 1 - 4).setMaxWidth(200);
        getColumnModel().getColumn(model.getColumnCount() - 1 - 4).setMinWidth(200);
        getColumnModel().getColumn(model.getColumnCount() - 1 - 4).setPreferredWidth(200);
        // hide ID column
        getColumnModel().getColumn(model.getColumnCount() - 1).setMaxWidth(0);
        getColumnModel().getColumn(model.getColumnCount() - 1).setMinWidth(0);
        getColumnModel().getColumn(model.getColumnCount() - 1).setPreferredWidth(0);
        // enable sorting
    ...
    protected void showInfo(int activityId) {
        ...
        if (activity != null) {
            ...
            // sub tasks
            //activitiesSubTable.setDataVector(tableData, columnNames); 
        }
    }
    ...
    protected void insertRow(Activity activity) {
        ...
        ((ActivitiesTableModel) getModel()).addRow(rowData); // we add in the Model...        
    ...
    protected void removeRow(int rowIndex) {
        ...
        ((ActivitiesTableModel) getModel()).removeRow(convertRowIndexToModel(rowIndex)); // we remove in the Model...
        if (getRowCount() > 0) {

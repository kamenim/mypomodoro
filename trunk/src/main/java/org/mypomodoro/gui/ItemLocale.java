...
public class ItemLocale {
     ...
     */
    public static Vector<ItemLocale> getLocalesFromPropertiesTitlefiles() {
        ...
        try {
            ...
            if (propertiesFiles.length > 0) {
                ...
                for (int i = 0; i < propertiesFiles.length; i++) {
                    ...
                    if (mat.find()) {
                        Locale l = new Locale(propertiesFiles[i].substring(0 + filePrefixLength, 2 + filePrefixLength), propertiesFiles[i].substring(3 + filePrefixLength, 5 + filePrefixLength), propertiesFiles[i].substring(6 + filePrefixLength, propertiesFiles[i].length() - fileExtensionLength));
                        vLocales.addElement(new ItemLocale(l, l.getDisplayLanguage() + " (" + l.getDisplayCountry() + ")" + " (" + l.getVariant() + ")"));
                    } else {
                        ...
                        if (mat.find()) {
                            ...
                            vLocales.addElement(new ItemLocale(l, l.getDisplayLanguage() + " (" + l.getDisplayCountry() + ")"));
                        }
                    }
                }
            }
            ...
            if (vLocales.isEmpty()) {
                vLocales.addElement(new ItemLocale(ControlPanel.preferences.getLocale(), ControlPanel.preferences.getLocale().getDisplayLanguage() + " (" + ControlPanel.preferences.getLocale().getDisplayCountry() + ")"));
            }
        }
        return vLocales;
    }
